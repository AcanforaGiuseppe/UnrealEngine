...
{
	/*
	 If BombermanOnline is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay
	 in BombermanOnline.Build.cs is not automatically propagated and a linker error will result.
